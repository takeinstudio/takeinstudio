              ...
              <div className="p-8 sm:p-12">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1">
                      <label className="text-[10px] font-bold uppercase tracking-widest ml-1 text-muted-foreground">Project Budget</label>
                      <select 
                        required 
                        name="budget"
                      ...
                      >
                        ...
                        <option value="50k-150k">₹50k - ₹1.5 Lakh</option>
                        <option value="150k-500k">₹1.5 Lakh - ₹5 Lakh</option>
                        <option value="500k+">₹5 Lakh+</option>
                      </select>
                    </div>
                  </div>
