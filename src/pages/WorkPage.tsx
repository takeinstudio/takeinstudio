...
const projects = [
  ...
  { title: "FitZone Pro", category: "Gyms", desc: "Membership app with workout tracking, bookings, and social features.", color: "from-accent/20 to-primary/10" },
  { title: "MediCare Connect", category: "Medical", desc: "Telemedicine platform connecting patients with specialists globally.", color: "from-warm-light to-accent/15" },
