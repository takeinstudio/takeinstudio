...
import { Lock, User, ArrowRight, ArrowLeft, LayoutDashboard, Users, FolderKanban, Loader2 } from "lucide-react";
    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-cream/30 p-4 sm:p-6 lg:p-8 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-4xl min-h-[580px] grid grid-cols-1 md:grid-cols-2 rounded-[2.5rem] bg-card border border-border/40 shadow-2xl overflow-hidden z-10">
        ...
        <div className="hidden md:flex flex-col justify-between p-10 bg-gradient-to-br from-primary via-orange-600 to-amber-600 text-white relative overflow-hidden">
          ...
          <div className="bg-white px-5 py-3 rounded-2xl border border-white/20 self-start shadow-xl flex items-center relative z-10">
            <img src="/logo/logo_no_text.png" alt="TakeIN Studio" className="h-8 md:h-10 w-auto object-contain mix-blend-multiply" />
          </div>
          ...
          >
            ...
            <motion.div variants={itemVariants} className="flex items-center gap-3">
              <div className="relative flex items-center justify-center">
                ...
                <motion.div 
                  ...
                  className="relative w-14 h-14 rounded-full border border-primary/30 bg-primary/5 flex items-center justify-center shadow-lg"
                >
                  <img src="/logo/logo_no_text.png" alt="Logo" className="w-8 h-8 object-contain mix-blend-multiply" />
                </motion.div>
              </div>
              <div>
            ...
            >
              ...
              <motion.button 
                ...
                className="glow-btn bg-primary text-primary-foreground w-full py-3.5 rounded-2xl flex items-center justify-center gap-2 text-sm font-bold tracking-wide mt-6 shadow-lg shadow-primary/20 disabled:opacity-70"
              >
                {loading ? <Loader2 className="animate-spin" size={16} /> : "SIGN IN"} {!loading && <ArrowRight size={16} />}
              </motion.button>
            </motion.form>
