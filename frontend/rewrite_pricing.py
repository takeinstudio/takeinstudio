  ...
  "web-development": [
    {
      ...
      "features": ["Modern responsive website", "Mobile optimization", "Contact form integration", "Basic SEO setup", "WhatsApp integration", "Domain & hosting connection", "30 days support"],
      "cta": "Start Project",
      "popular": False
    },
    {
      ...
      "features": ["Premium custom website", "Advanced UI/UX", "Smooth animations", "SEO optimization", "CMS integration", "Gallery/blog management", "Lead capture forms", "Performance optimization", "60 days support"],
      "cta": "Get Started",
      "popular": True
    },
    {
      ...
      "features": ["Everything in Professional", "Admin dashboard", "Dynamic content management", "Database integration", "API integrations", "Business workflows", "Analytics setup", "Priority support"],
    ...
    },
    {
      ...
      "features": ["Custom software architecture", "AI integrations", "Business automation", "CRM/ERP integrations", "Internal dashboards", "Scalable infrastructure", "Long-term support plans"],
      "cta": "Contact Sales",
      "popular": False
    }
  ],
  "app-development": [
    {
      ...
      "features": ["Cross-platform mobile app", "Modern UI", "User authentication", "Firebase integration", "Basic backend", "App deployment assistance", "30 days support"],
      "cta": "Start Project",
      "popular": False
    },
    {
      ...
      "features": ["Premium UI/UX", "Custom backend", "Database integration", "Push notifications", "Payment gateway integration", "Admin dashboard", "Analytics setup", "60 days support"],
      "cta": "Get Started",
      "popular": True
    },
    {
      ...
      "features": ["Everything in Business", "Role-based access", "API integrations", "Real-time functionality", "Advanced dashboards", "Performance optimization", "Priority support"],
      "cta": "Book Consultation",
      "popular": False
    },
    {
      ...
      "features": ["AI-powered applications", "Multi-platform ecosystems", "Enterprise integrations", "Advanced automation", "Scalable architecture", "Dedicated project planning"],
      "cta": "Contact Sales",
      "popular": False
    }
  ],
  "custom-software": [
    {
      ...
      "features": ["Basic process automation", "Third-party API connections", "Simple webhooks", "Data syncing", "Basic error handling", "30 days support"],
      "cta": "Start Project",
      "popular": False
    },
    {
      ...
      "features": ["Custom web application", "Admin control panel", "Database design", "Role-based authentication", "Complex API integrations", "Data visualization", "60 days support"],
      "cta": "Get Started",
      "popular": True
    },
    {
      ...
      "features": ["Microservices architecture", "Legacy system modernization", "Advanced security protocols", "High-availability servers", "Custom ERP/CRM systems", "Dedicated engineering team"],
      "cta": "Contact Sales",
      "popular": False
    }
  ],
  "ai-automation": [
    {
      ...
      "features": ["Custom AI Chatbot integration", "OpenAI / Claude API setup", "Prompt engineering", "Basic customer support bot", "Contextual memory setup", "30 days support"],
      "cta": "Start Project",
      "popular": False
    },
    {
      ...
      "features": ["AI Agent workflow automation", "Document parsing & RAG", "Custom fine-tuning consulting", "Multi-agent systems", "Internal knowledge base AI", "API workflow triggers", "60 days support"],
      "cta": "Get Started",
      "popular": True
    },
    {
      ...
      "features": ["On-premise / Secure LLM hosting", "Proprietary model training", "Complex data pipelines", "Enterprise security compliance", "Voice & Vision AI", "Dedicated AI architects"],
      "cta": "Contact Sales",
      "popular": False
    }
  ],
  "website-maintenance": [
    {
      ...
      "features": ["Security monitoring", "Website/app health checks", "Backup management", "Minor content updates", "Bug fixes", "Email support"],
      "cta": "Start Project",
      "popular": False
    },
    {
      ...
      "features": ["Everything in Starter", "Priority support", "Performance optimization", "SEO health monitoring", "Database maintenance", "Content update assistance"],
      "cta": "Get Started",
      "popular": True
    },
    {
      ...
      "features": ["Everything in Growth", "Advanced monitoring", "Faster issue resolution", "Quarterly optimization reviews", "Dedicated support channel", "Detailed maintenance reports"],
      "cta": "Book Consultation",
      "popular": False
    },
    {
      ...
      "features": ["Dedicated support plans", "Infrastructure management", "AI system maintenance", "Enterprise integrations", "Long-term roadmap consulting", "Priority response agreements"],
      "cta": "Contact Sales",
      "popular": False
    }
  ],
  "video-editing": [
    {
      ...
      "features": ["Up to 60 seconds", "Dynamic captions", "Trending audio sync", "B-roll & transitions", "Color correction", "1 Revision"],
      "cta": "Start Project",
      "popular": False
    },
    {
      ...
      "features": ["Up to 15 minutes", "Multi-cam syncing", "Advanced motion graphics", "Audio mixing & leveling", "Thumbnail design", "3 Revisions"],
      "cta": "Get Started",
      "popular": True
    },
    {
      ...
      "features": ["Cinematic grading", "Advanced VFX", "Storyboarding", "Licensed premium music", "Format optimization", "Unlimited revisions"],
      "cta": "Contact Sales",
      "popular": False
    }
  ],
  "graphic-design": [
    {
      ...
      "features": ["2 Custom Post Designs", "Platform-specific sizing", "Brand color matching", "High-res delivery", "1 Revision"],
      "cta": "Start Project",
      "popular": False
    },
    {
      ...
      "features": ["3 Custom Logo Concepts", "Brand Color Palette", "Typography Guidelines", "Business Card Design", "Social Media Kit", "3 Revisions"],
      "cta": "Get Started",
      "popular": True
    },
    {
      ...
      "features": ["Comprehensive Brand Book", "UI/UX Design Language", "Marketing Collaterals", "Presentation Templates", "Merchandise Design", "Unlimited Revisions"],
      "cta": "Contact Sales",
      "popular": False
    }
  ],
  "digital-branding-smm": [
    {
      ...
      "features": ["8 Posts per month", "Basic caption writing", "Hashtag research", "Monthly scheduling", "Basic engagement", "Monthly report"],
      "cta": "Start Project",
      "popular": False
    },
    {
      ...
      "features": ["15 Posts + 4 Reels/mo", "Strategic copywriting", "Competitor analysis", "Active community engagement", "Ad campaign management", "Detailed analytics"],
      "cta": "Get Started",
      "popular": True
    },
    {
      ...
      "features": ["Omnichannel strategy", "Dedicated Account Manager", "Daily posting & engagement", "Viral campaign creation", "Influencer outreach", "Real-time PR management"],
      "cta": "Contact Sales",
      "popular": False
    }
  ],
  "seo-marketing": [
    {
      ...
      "features": ["Google My Business setup", "Local keyword targeting", "On-page optimization", "Basic directory listings", "Monthly rank tracking", "Technical SEO audit"],
      "cta": "Start Project",
      "popular": False
    },
    {
      ...
      "features": ["Comprehensive keyword mapping", "Advanced on-page SEO", "High DA backlink building", "Content strategy & briefs", "Competitor gap analysis", "Speed optimization consulting"],
      "cta": "Get Started",
      "popular": True
    },
    {
      ...
      "features": ["Google/Meta Ads management", "Enterprise site architecture", "Programmatic SEO", "Conversion Rate Optimization (CRO)", "A/B Testing", "Dedicated Marketing Lead"],
      "cta": "Contact Sales",
      "popular": False
    }
  ]
...
tsx_code = f'''import {{ useState, useEffect }} from "react";
...
const pricingData: Record<string, any[]> = {json.dumps(pricing_data, indent=2)};
              ...
              <AnimatedSection key={{`${{activeTab}}-${{t.name}}`}} delay={{i * 0.1}}>
                ...
                >
                  ...
                  <Link
                    ...
                    className={{`w-full py-2.5 rounded-lg text-xs font-bold tracking-wide text-center transition-all flex items-center justify-center gap-1.5 ${{
                      t.popular 
...
print("PricingPage fully rewritten.")
