...
export default function AIMLPaymentSuccess() {
  return (
    <>
      <SEO
        title="Payment Received — AI/ML Roadmap | TakeIN Studio"
        description="Your payment has been received. TakeIN Studio will verify and activate your AI/ML Roadmap access shortly."
        url="https://takeinstudio.com/vault/ai-ml/payment-success"
      />
              ...
              <div className="space-y-5">
                {[
                  ...
                  },
                  {
                    icon: CheckCircle2,
                    title: "You're in",
                    desc: "Use your credentials to access the AI/ML Engineer Career Execution Roadmap.",
