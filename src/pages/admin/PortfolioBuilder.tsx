...
const defaultPortfolio = [
  {
    id: "p1",
    title: "Aayojana Events Platform",
    category: "Web Development",
    desc: "A comprehensive event management platform offering seamless vendor bookings, customer portals, and real-time scheduling.",
    color: "from-primary/30 to-accent/20",
    features: ["Vendor Management", "Customer Portals", "Real-time Booking"],
    image: "",
    website_link: "https://aayojanaevents.com",
    case_study: "",
    section: "Featured Client Work",
    featured: true
  },
  {
    id: "p2",
    title: "Astha Associate",
    category: "Corporate Website",
    desc: "A premium corporate web portal for Astha Associate, showcasing infrastructure, real estate projects, and client testimonials.",
    color: "from-accent/30 to-primary/20",
    features: ["Project Showcase", "Lead Generation", "Dynamic CMS"],
    image: "",
    website_link: "",
    case_study: "",
    section: "Featured Client Work",
  ...
  {
    id: "p3",
    title: "TakeIN CMS Engine",
    category: "Custom Software",
    desc: "A high-performance proprietary Content Management System powering ultra-fast, dynamic portfolios and client portals.",
    color: "from-blue-500/30 to-indigo-500/20",
    features: ["Live Preview", "Instant Sync", "Secure Admin Area"],
    image: "",
    website_link: "",
    case_study: "",
