...
export default function AboutPage() {
  ...
  const mainTitle = getText('about_main_title', '');
  const mainDesc = getText('about_main_desc', '');
  const missionTitle = getText('about_mission_title', '');
  const missionDesc = getText('about_mission_desc', '');
          ...
          >
            ...
            <motion.div variants={itemVariants}>
              <p className="text-muted-foreground text-sm sm:text-base leading-relaxed font-semibold max-w-2xl mx-auto">
                {mainDesc || "We are a global digital studio focused on building high-performance websites, mobile applications, and custom software systems that drive real business growth."}
              </p>
            </motion.div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center max-w-7xl relative z-10">
          ...
          <AnimatedSection className="lg:col-span-7 text-left space-y-4">
            ...
            <h2 className="font-display text-3xl font-bold leading-tight">
              {missionTitle || "We build digital foundations that empower ambition."}
            </h2>
            <p className="text-muted-foreground text-sm leading-relaxed max-w-xl">
              {missionDesc || "Our philosophy is simple: technology should serve your business, not the other way around. We focus on writing clean code, designing intuitive interfaces, and building resilient architectures so you can focus on scaling your operations."}
            </p>
          </AnimatedSection>
